...
**`scripts/update_now.py`** — Fetches my Notion databases every night and updates the *Right Now* section with whatever I'm currently playing, watching, and reading. Ratings included.
...
*Built with Claude. Hosted on Vercel. Fuelled by coffee and Sekiro deaths.*
